 ...
 */
class getServiceAccountRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ServiceAccountRepository' shared autowired service.
     *
     * @return \App\Repository\ServiceAccountRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceAccountRepository.php';

        return $container->privates['App\\Repository\\ServiceAccountRepository'] = new \App\Repository\ServiceAccountRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

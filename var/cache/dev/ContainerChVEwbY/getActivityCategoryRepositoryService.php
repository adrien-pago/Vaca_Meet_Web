 ...
 */
class getActivityCategoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ActivityCategoryRepository' shared autowired service.
     *
     * @return \App\Repository\ActivityCategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActivityCategoryRepository.php';

        return $container->privates['App\\Repository\\ActivityCategoryRepository'] = new \App\Repository\ActivityCategoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
